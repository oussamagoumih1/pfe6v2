...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
            com.example.testpfe.bean.User appUser= new ObjectMapper().readValue(request.getInputStream(), com.example.testpfe.bean.User.class);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        com.example.testpfe.bean.User user=(com.example.testpfe.bean.User)authResult.getPrincipal();

        UserService userService = TestpfeApplication.getCtx().getBean(UserService.class);
        com.example.testpfe.bean.User myUser = userService.findByUsernameWithRoles(user.getUsername());
