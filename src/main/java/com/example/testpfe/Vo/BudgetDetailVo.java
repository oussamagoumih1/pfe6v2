...
public class BudgetDetailVo {
    ...
    private BigDecimal mtInvReserveReliquatMin;
    private BigDecimal mtInvReserveReliquatMax;
    private BigDecimal mtInvPayeReliquat;
    private BigDecimal mtInvPayeReliquatMin;
    private BigDecimal mtInvPayeReliquatMax;
    ...
    public BigDecimal getMtInvReserveReliquatMin() {
        return mtInvReserveReliquatMin;
    }

    public void setMtInvReserveReliquatMin(BigDecimal mtInvReserveReliquatMin) {
        this.mtInvReserveReliquatMin = mtInvReserveReliquatMin;
    }

    public BigDecimal getMtInvReserveReliquatMax() {
        return mtInvReserveReliquatMax;
    }

    public void setMtInvReserveReliquatMax(BigDecimal mtInvReserveReliquatMax) {
        this.mtInvReserveReliquatMax = mtInvReserveReliquatMax;
    }
    ...
    public BigDecimal getMtInvPayeReliquatMin() {
        return mtInvPayeReliquatMin;
    }

    public void setMtInvPayeReliquatMin(BigDecimal mtInvPayeReliquatMin) {
        this.mtInvPayeReliquatMin = mtInvPayeReliquatMin;
    }

    public BigDecimal getMtInvPayeReliquatMax() {
        return mtInvPayeReliquatMax;
    }

    public void setMtInvPayeReliquatMax(BigDecimal mtInvPayeReliquatMax) {
        this.mtInvPayeReliquatMax = mtInvPayeReliquatMax;
    }
